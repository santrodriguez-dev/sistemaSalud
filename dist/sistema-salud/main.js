...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"], _shared_servicios_utils_service__WEBPACK_IMPORTED_MODULE_6__["UtilsService"], _shared__WEBPACK_IMPORTED_MODULE_8__["RutasService"]],
...
var LoginService = /** @class */ (function () {
    function LoginService(http, rutas) {
        this.http = http;
        this.rutas = rutas;
    }
    LoginService.prototype.validarCredenciales = function (credenciales) {
        var _this = this;
        return this.http.post(this.rutas.rutasServicios.urlServidor + 'usuarios/login', credenciales)
    ...
    LoginService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _shared__WEBPACK_IMPORTED_MODULE_2__["RutasService"]])
    ], LoginService);
    return LoginService;
}());
...
var ListadoPacientesComponent = /** @class */ (function () {
    function ListadoPacientesComponent(_pacientesService, router, route) {
    ...
    ListadoPacientesComponent.prototype.nuevoPaciente = function () {
...
var routes = [
    ...
    {
        path: '', children: [
            { path: '', component: _listado_pacientes_listado_pacientes_component__WEBPACK_IMPORTED_MODULE_8__["ListadoPacientesComponent"] },
            { path: 'modificar/:id', component: _registro_pacientes_registro_pacientes_component__WEBPACK_IMPORTED_MODULE_6__["RegistroPacientesComponent"] },
            { path: 'crear', component: _registro_pacientes_registro_pacientes_component__WEBPACK_IMPORTED_MODULE_6__["RegistroPacientesComponent"] },
            { path: '**', redirectTo: '' }
        ]
    },
];
...
var RegistroPacientesComponent = /** @class */ (function () {
    function RegistroPacientesComponent(fb, router, route, snackBar, _pacientesService, utilServ) {
        this.fb = fb;
        this.router = router;
        this.route = route;
        this.snackBar = snackBar;
    ...
    RegistroPacientesComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            if (_this.idPaciente) {
                _this.modoEditable = true;
                _this.cargarPaciente();
            }
        });
    };
    RegistroPacientesComponent.prototype.cargarPaciente = function () {
        var _this = this;
        this._pacientesService.cargarPaciente(this.idPaciente).subscribe(function (resBD) {
            _this.registroPacForm.patchValue(resBD);
        });
    };
    RegistroPacientesComponent.prototype.onSubmit = function (regForm) {
    ...
    RegistroPacientesComponent.prototype.resetForm = function (formDirective) {
        if (this.modoEditable) {
            this.cargarPaciente();
            return;
        }
    ...
    RegistroPacientesComponent.prototype.volverAtras = function () {
        if (this.modoEditable) {
    ...
    RegistroPacientesComponent.prototype.obtenerTitulo = function () {
        if (this.modoEditable) {
...
var PacientesService = /** @class */ (function () {
    function PacientesService(http, util, rutas) {
        this.http = http;
        this.util = util;
        this.rutas = rutas;
    ...
    PacientesService.prototype.getAllPacientes = function () {
        return this.http.get(this.rutas.rutasServicios.urlServidor + 'pacientes/getall').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            if (res.satisfactorio) {
                return res.resultado;
            }
        }));
    };
    PacientesService.prototype.cargarPaciente = function (idPaciente) {
        return this.http.get(this.rutas.rutasServicios.urlServidor + 'pacientes/get/' + idPaciente).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            if (res.satisfactorio) {
                return res.resultado;
            }
        }));
    ...
    PacientesService.prototype.crearPaciente = function (paciente) {
        return this.http.post(this.rutas.rutasServicios.urlServidor + 'pacientes/new', paciente).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            return res.satisfactorio;
        }));
    };
    PacientesService.prototype.eliminarPaciente = function (paciente) {
        return this.http.delete(this.rutas.rutasServicios.urlServidor + 'pacientes/delete/' + paciente.nom_usuario)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            return res.satisfactorio;
        }));
    };
    PacientesService.prototype.actualizarPaciente = function (paciente) {
        return this.http.put(this.rutas.rutasServicios.urlServidor + 'pacientes/update/', paciente)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            return res.satisfactorio;
        }));
    };
    ...
    PacientesService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            ...
            _shared__WEBPACK_IMPORTED_MODULE_3__["RutasService"]])
    ], PacientesService);
...
var InfoSolicitudComponent = /** @class */ (function () {
    function InfoSolicitudComponent(route, _solicitudesService, router, utilServ) {
        ...
        this.router = router;
        this.utilServ = utilServ;
        this.displayedColumns = ['id', 'diagnostico', 'observacion', 'createdAt'];
    }
    ...
    InfoSolicitudComponent.prototype.cargarSeguimiento = function () {
        var _this = this;
        this.utilServ.mostrarCargando(true);
        this._solicitudesService.obtenerSeguimientoSolicitud(this.id).subscribe(function (segui) {
            _this.seguimiento = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](segui);
            _this.seguimiento.paginator = _this.paginator;
            _this.seguimiento.sort = _this.sort;
            _this.utilServ.mostrarCargando(false);
        }, function (err) {
            console.log(err);
            _this.utilServ.mostrarCargando(false);
    ...
    InfoSolicitudComponent.prototype.mapReady = function (mapa) {
        this.mapa = mapa;
    };
    InfoSolicitudComponent.prototype.localizarPaciente = function () {
        var ub = {
    ...
    InfoSolicitudComponent.prototype.trazarRutaPaciente = function () { };
    InfoSolicitudComponent.prototype.filaSeleccionada = function (fila) { };
    InfoSolicitudComponent.prototype.applyFilter = function (filterValue) {
    ...
    ], InfoSolicitudComponent.prototype, "sort", void 0);
    __decorate([
    ...
    ], InfoSolicitudComponent.prototype, "paginator", void 0);
...
var SolicitudesService = /** @class */ (function () {
    function SolicitudesService(http, util, rutas) {
        this.http = http;
        this.util = util;
        this.rutas = rutas;
    }
    SolicitudesService.prototype.getAllSolicitudes = function () {
        return this.http.get(this.rutas.rutasServicios.urlServidor + 'solicitudes/getall').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            if (res.satisfactorio) {
                return res.resultado;
            }
        }));
    ...
    SolicitudesService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _shared__WEBPACK_IMPORTED_MODULE_2__["UtilsService"],
            _shared__WEBPACK_IMPORTED_MODULE_2__["RutasService"]])
    ], SolicitudesService);
...
/*!*********************************!*\
  !*** ./src/app/shared/index.ts ***!
  \*********************************/
/*! exports provided: UtilsService, RutasService, MaterialModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _servicios_rutas_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./servicios/rutas.service */ "./src/app/shared/servicios/rutas.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RutasService", function() { return _servicios_rutas_service__WEBPACK_IMPORTED_MODULE_2__["RutasService"]; });
...
/***/ "./src/app/shared/servicios/rutas.service.ts":
/*!***************************************************!*\
  !*** ./src/app/shared/servicios/rutas.service.ts ***!
  \***************************************************/
...
var RutasService = /** @class */ (function () {
    ...
    RutasService.prototype.cargarRutaServidor = function () {
        var _this = this;
...
/* harmony import */ var _rutas_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rutas.service */ "./src/app/shared/servicios/rutas.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UtilsService = /** @class */ (function () {
    function UtilsService(rutas) {
        this.rutas = rutas;
        this.cambioCargando = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](false);
    ...
    UtilsService = __decorate([
        ...
        __metadata("design:paramtypes", [_rutas_service__WEBPACK_IMPORTED_MODULE_2__["RutasService"]])
    ], UtilsService);
    return UtilsService;
}());
